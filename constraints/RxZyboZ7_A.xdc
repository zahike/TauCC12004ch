...
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports CS_nc]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports MOSIc]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports MISOc]
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33} [get_ports { jd_p[1] }]; #IO_L5N_T0_34 Sch=jd_n[1]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33} [get_ports { jd_n[1] }]; #IO_L5P_T0_34 Sch=jd_p[1]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33} [get_ports { jd_p[2] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33} [get_ports { jd_n[2] }]; #IO_L6P_T0_34 Sch=jd_p[2]

#set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports {jd_n[1]}]
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {jd_p[1]}]
#set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports {jd_n[2]}]
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {jd_p[2]}]

set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports SCLKd]
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports CS_nd]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports MOSId]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports MISOd]
