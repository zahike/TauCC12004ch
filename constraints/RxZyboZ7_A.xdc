...
set_property PULLUP true [get_ports {jb_p[1]}]
...
set_property PULLDOWN true [get_ports MISOb]
...
set_property PULLUP true [get_ports {jc_p[1]}]
...
set_property PULLDOWN true [get_ports MISOc]
...
set_property PULLUP true [get_ports {jd_p[1]}]
...
set_property PULLDOWN true [get_ports MISOd]
...
set_property PULLUP true [get_ports {je[1]}]
