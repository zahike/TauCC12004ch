...
# module references:
# AXI_BayerToRGB, CC1200_reap, SCCBGPIO_Top, TxHDMI, TxMem, TxSyntPic
...
proc create_root_design { parentCell } {
  ...
  set GPIO_OutEn [ create_bd_port -dir O -from 15 -to 0 GPIO_OutEn ]
  set MISO [ create_bd_port -dir I -from 3 -to 0 MISO ]
  set MOSI [ create_bd_port -dir O -from 3 -to 0 MOSI ]
  set Mem_cont [ create_bd_port -dir I -from 3 -to 0 Mem_cont ]
  set SCLK [ create_bd_port -dir O -from 3 -to 0 SCLK ]
  ...
  # Create instance: CC1200_reap_0, and set properties
  set block_name CC1200_reap
  set block_cell_name CC1200_reap_0
  if { [catch {set CC1200_reap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CC1200_reap_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net CC1200_reap_0_APB_S_0_prdata [get_bd_pins CC1200_reap_0/APB_S_0_prdata] [get_bd_pins axi_apb_bridge_1/m_apb_prdata]
  connect_bd_net -net CC1200_reap_0_APB_S_0_pready [get_bd_pins CC1200_reap_0/APB_S_0_pready] [get_bd_pins axi_apb_bridge_1/m_apb_pready]
  connect_bd_net -net CC1200_reap_0_APB_S_0_pslverr [get_bd_pins CC1200_reap_0/APB_S_0_pslverr] [get_bd_pins axi_apb_bridge_1/m_apb_pslverr]
  connect_bd_net -net CC1200_reap_0_CS_n [get_bd_ports CS_n] [get_bd_pins CC1200_reap_0/CS_n] [get_bd_pins ila_0/probe8]
  connect_bd_net -net CC1200_reap_0_GPIO_Out [get_bd_ports GPIO_Out] [get_bd_pins CC1200_reap_0/GPIO_Out]
  connect_bd_net -net CC1200_reap_0_GPIO_OutEn [get_bd_ports GPIO_OutEn] [get_bd_pins CC1200_reap_0/GPIO_OutEn]
  connect_bd_net -net CC1200_reap_0_MOSI [get_bd_ports MOSI] [get_bd_pins CC1200_reap_0/MOSI] [get_bd_pins ila_0/probe6]
  ...
  connect_bd_net -net TxMem_0_FraimSync [get_bd_pins CC1200_reap_0/TranFraimSync] [get_bd_pins TxHDMI_0/FraimSync] [get_bd_pins TxMem_0/TranFraimSync] [get_bd_pins ila_0/probe1]
  ...
  connect_bd_net -net TxMem_0_TranAdd [get_bd_pins CC1200_reap_0/TranAdd] [get_bd_pins TxMem_0/TranAdd] [get_bd_pins ila_0/probe4]
  connect_bd_net -net TxMem_0_TranData [get_bd_pins CC1200_reap_0/TranData] [get_bd_pins TxMem_0/TranData] [get_bd_pins ila_0/probe3]
  connect_bd_net -net TxMem_0_TranEn [get_bd_pins CC1200_reap_0/TranEn] [get_bd_pins TxMem_0/TranEn] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net axi_apb_bridge_1_m_apb_paddr [get_bd_pins CC1200_reap_0/APB_S_0_paddr] [get_bd_pins axi_apb_bridge_1/m_apb_paddr]
  connect_bd_net -net axi_apb_bridge_1_m_apb_penable [get_bd_pins CC1200_reap_0/APB_S_0_penable] [get_bd_pins axi_apb_bridge_1/m_apb_penable]
  connect_bd_net -net axi_apb_bridge_1_m_apb_psel [get_bd_pins CC1200_reap_0/APB_S_0_psel] [get_bd_pins axi_apb_bridge_1/m_apb_psel]
  connect_bd_net -net axi_apb_bridge_1_m_apb_pwdata [get_bd_pins CC1200_reap_0/APB_S_0_pwdata] [get_bd_pins axi_apb_bridge_1/m_apb_pwdata]
  connect_bd_net -net axi_apb_bridge_1_m_apb_pwrite [get_bd_pins CC1200_reap_0/APB_S_0_pwrite] [get_bd_pins axi_apb_bridge_1/m_apb_pwrite]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports FCLK_CLK2_0] [get_bd_pins CC1200_reap_0/APBclk] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aclk] [get_bd_pins SCCBGPIO_Top_0/clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_apb_bridge_1/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins AXI_BayerToRGB_0/StreamClk] [get_bd_pins CC1200_reap_0/clk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins TxMem_0/Cclk] [get_bd_pins TxSyntPic_0/clk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ila_0/clk] [get_bd_pins rgb2dvi_0/SerialClk] [get_bd_pins rst_clk_wiz_0_50M1/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M1_peripheral_aresetn [get_bd_pins AXI_BayerToRGB_0/sStreamReset_n] [get_bd_pins CC1200_reap_0/rstn] [get_bd_pins TxHDMI_0/rstn] [get_bd_pins TxMem_0/rstn] [get_bd_pins TxSyntPic_0/rstn] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins rst_clk_wiz_0_50M1/peripheral_aresetn]
